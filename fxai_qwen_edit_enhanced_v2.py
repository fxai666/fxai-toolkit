...
class FxAiQwenEditEnhancedV2:
    ...
    def encode(self, clip, vae, width, height, 用户提示词="", 负面提示词=None, 图片列表=None,系统提示词=None, unique_id=None):
        ...
        if img_batch is None:
            img_count = 0
        elif isinstance(img_batch, list):
        ...
        if not 负面提示词:
            负面提示词 = "丑陋，模糊，低分辨率，最差质量，低质量，JPEG伪影，解剖结构错误，畸形，毁容，突变，多余肢体，多余手臂，多余腿，畸形肢体，手部画得差，手部畸形，多余手指，缺少手指，手指缺失，手指融合，脸部画得差，脸部畸形，毁容的脸，斗鸡眼，长脖子，多余的眼睛，文字，词语，签名，水印，用户名，标志，边框，画框，平铺重复，画得差，出框，错误，画面裁切，畸形的身体，杂乱背景，过度滤镜，画面暗沉发黑"
